/* ============================================================================
   ...
   Dependency-free, offline.  Edit the films in the DEMOS array below.
   ============================================================================ */
...
const DEMOS = [
  ...
  {
    key:"little_calf", title:"Run, Little Calf",
    genre:"3D · Family Comedy", cat:"Narrative",
    prompt:"一部一分钟的三维动画喜剧短片，画风是明亮饱和的卡通 CG，森林与小河的自然场景。\n\n片名固定为《Run, Little Calf》。主角是小牛，片名和 logline 都必须以小牛为中心。吓跑小牛的是一条小白蛇；小红鸟是会说话的配角，不要出现在片名里。\n\n角色（只有两头牛，是父子）：\n- 小牛（主角，儿子）：一头橙黄色的卡通小牛，个头只到爸爸的腰，两脚站立走路，圆脸、大眼睛、大耳朵、宽鼻头、短短的小角，胆小、好奇、爱大惊小怪。所有角色都是拟人化的卡通动物，不是人类。\n- 牛爸爸：一头橙棕色的壮年公牛，头顶一对又粗又长的弯角，两脚站立，眉头常皱着，说话慢条斯理，对儿子的闯祸见怪不怪，喜欢冷幽默。\n- 小白蛇：一条筷子那么细的乳白色小蛇，喜欢把身子笔直立起来、昂着头看人，看着吓人其实无害。\n- 小红鸟：一只巴掌大的红色小鸟，长嘴长尾，会说话，是这家牛的伙伴兼哨兵，嗓门大、爱操心，一直在父子俩附近飞来飞去，家里的事它都知道。\n\n剧情（按顺序）：\n1. 白天，森林边的草坡，小牛站在一块大石头旁边发呆，没注意脚边草里有什么。一只小红鸟从树林上空俯冲过来，一边飞一边冲他大喊：\"Quick — look behind you!\" 小牛转头，正看见一条小白蛇在他脚边笔直地立起来、昂着头盯着他，小牛吓得原地一蹦，大喊 \"Snake!\"\n2. 小牛尖叫 \"Help!\"，撒腿就跑，小白蛇留在原地一脸无辜。小牛一路穿过密密的树干，镜头在树林间快速穿梭追着他，他一个助跑跳过小河，结果\"砰\"一声脸撞在对岸一棵大树上，顺着树干滑坐到地上。\n3. 小牛抱着脸蹲在树根下直喊 \"Ow, ow, ow.\"。牛爸爸慢悠悠踱过来，低头问 \"Now what?\" 小牛委屈地说：\"I jumped the creek. I hit the tree.\" 牛爸爸抬头看了看那棵被撞得叶子直掉的树，慢慢说：\"Then shouldn't the tree be the one crying?\" 小牛愣住。\n4. 这时小红鸟轻轻落在父子俩脚边，仰着头看他们。牛爸爸低头看着小红鸟，忽然想起什么，直接问小红鸟：\"By the way — where did his mother go?\" 这里的\"他\"指小牛，牛爸爸是在向小红鸟打听小牛的妈妈（也就是自己的妻子）去了哪里。小红鸟歪头一脸茫然，小牛也跟着东张西望，父子俩对视一眼，再一起看向小红鸟，画面定格，结束。\n\n调性：轻松搞笑、家庭向，没有真正的危险，笑点在小牛的大惊小怪和牛爸爸的冷幽默与心不在焉。**对白和字幕一律用英语**，短句口语，上面剧情里引号内的英文就是意向台词。全程横屏 16:9。**画面内不要生成任何文字**（字幕由后期烧录，不要画进镜头里）。",
    prompt_en:"A one-minute 3D cartoon comedy from a single brief. On a sunlit slope a little orange calf stands daydreaming when a palm-sized red bird dives past yelling 'Quick — look behind you!'; he turns to find a chopstick-thin white snake stood bolt upright and staring back, screams and bolts, tears through the woods, clears the creek in one leap and runs face-first into a tree. Nursing his nose among the falling leaves he wails; his father — a burly orange-brown bull with long curved horns, slow of speech and long past being surprised by his son — ambles over, hears 'I jumped the creek. I hit the tree,' looks the now-bare tree up and down and wonders aloud whether the tree shouldn't be the one crying. The bird lands at their hooves, the father asks it where the boy's mother has got to, and father and son freeze mid-glance. Bright, saturated cartoon-CG 3D animation, landscape 16:9, native foley throughout, and the brief expressly forbids any lettering drawn into the shots.\n\nThe film speaks and subtitles in English, and neither is a setting the brief had to ask for: the deliverable's language is pinned rather than inferred — left to itself the story head reads the spoken language off the setting — and every plan that delivers a film now carries a transcription pass before the composite, so the burned-in captions come from the finished cut rather than from the script. That matters where this was shown: a room loud enough that a film without captions delivers only its picture. An earlier version of this same brief was made in Mandarin, with the subtitles added in a second turn over the already-rendered cut.",
    src:"videos/little_calf.mp4", poster:"posters/little_calf.jpg",
    io:{in:"Instruction only", out:["Multi-shot dynamic video","Speech / voice-over audio","Music / Foley / sound effects","Subtitles","Final audiovisual composition"]},
  },
  {
    ...
    io:{in:"Instruction only", out:["Multi-shot dynamic video","Speech / voice-over audio","Music / Foley / sound effects","Translated subtitles (zh \u2192 en)","Final audiovisual composition"]},
  },
  {
  ...
  },
  {
    ...
    prompt_en:"A footage-pack edit: the user drops a pile of loose travel and event clips of assorted lengths \u2014 throwaway takes included \u2014 and asks for the highlights cut into a reel, with the blurry, repetitive and boring parts thrown out. Here: 12 clips cut from CC-licensed contemporary footage (aerial beaches, Japanese coastline, Sikkim mountains, a mountain stream, a train window), deliberately salted with one out-of-focus take, two near-duplicates and a 22-second static stretch. The system described all 12, analysed all 12, and cut 57 seconds from eight of them \u2014 eight different sources against the asked-for ~60 \u2014 leaving out every salted throwaway. The pack is silent, so there is no speech to subtitle: the short on-screen lines are authored per selected clip and burned over that clip's window. The vertical phone clip letterboxes into the 1080p frame rather than being stretched. No score \u2014 the brief asks for a music-synced cut and the music backend is currently unavailable.",
    src:"videos/reel_travel.mp4", poster:"posters/reel_travel.jpg",
    inputs:["clip_01_travel.mp4", "clip_02_travel.mp4", "clip_03_travel.mp4", "clip_04_travel.mp4", "clip_05_travel.mp4", "clip_06_travel.mp4", "clip_07_travel.mp4", "clip_08_travel.mp4", "clip_09_blurry.mp4", "clip_10_dup.mp4", "clip_11_static.mp4", "clip_12_dup2.mp4"],
    io:{in:"Instruction + video assets", out:["Refined existing video","Final audiovisual composition"]},
  },
  {
    key:"bridge", title:"Six Hundred More Years",
    genre:"Documentary \u00b7 Heritage Restoration", cat:"Explainer", pipeline:"explainer",
    prompt:"I'm with a cultural heritage project in Europe, and I want a documentary explainer about a medieval stone arch bridge we've just finished restoring. The accuracy rests entirely on the script I'm giving you — read it as written and don't fill anything in yourself: the date of the bridge, where the stone came from, the several times floods damaged it and the traditional methods we used this time are all in the script, and not a single figure can be changed or added. I'm providing real photo references of the bridge after restoration, and the bridge in the film has to match those exactly — the curve of the arch, the texture of the joints between the stones, those are the real thing. For the narration we had a local craftsman record the commentary in English; use his real human voice, the bit of accent is exactly the texture we want, don't replace it. I'm also attaching a string-music recording we made to sit underneath. The finished piece should be documentary with a light infographic feel, steady in tone. English narration with English subtitles, and fill in chisel and running-water ambience to match what's on screen. The runtime follows the narration audio, around a minute and a half.\n\nHere is the commentary, word for word:\n\nproject record; nothing may be changed, rounded, or added.\n\nThe Pont de la Roche-Vieille was completed in 1387. It carries a single\nsegmental arch of twenty-two metres over the Vère, and it has stood for six\nhundred and thirty-nine years.\n\nThe stone is a local grey limestone, quarried at Saint-Martin-de-Vère, four\nkilometres upstream. We went back to the same quarry for this work, so that\nevery replacement block came out of the same bed as the original.\n\nThe river has taken the bridge three times. The flood of 1612 carried away the\neastern parapet. In 1875 the western cutwater was undermined and lost. And in\nOctober 2019 a hundred-year flood opened a crack through the arch ring itself.\n\nWe rebuilt it the way it was built. The blocks were dressed by hand with a\npoint chisel and a bush hammer, no power tools on any visible face. They were\nset in a hot-mixed lime mortar, six parts sand to one part quicklime, with no\ncement anywhere in the structure. The arch was reset on a timber centring\nbuilt on site from green oak.\n\nThe work took nineteen months. Four masons, one carpenter, and one\napprentice — who is now a mason.\n\nThe bridge is open again. It is expected to stand another six hundred years.",
    prompt_en:"A heritage project's restoration film, and the hardest input case so far: a commentary that must be read as written (dates, quarry, the 1612 / 1875 / 2019 floods, a 6:1 hot-mixed lime, nineteen months \u2014 not a figure may change), three real photographs the bridge on screen has to match, the craftsman's own recorded English narration to be used as his voice rather than re-dubbed, and a string bed underneath. The bridge is locked to the uploaded photos through an identity anchor built FROM them, so the single segmental arch, the grey limestone and the wide pale mortar joints hold across all nine shots. Subtitles are transcribed from the craftsman's recording; the ASR mishears the French place names, so two proper nouns are spelled differently from the script.",
    src:"videos/bridge.mp4", poster:"posters/bridge.jpg",
    inputs:["bridge_side.jpg","bridge_joints.jpg","bridge_deck.jpg","craftsman_narration.wav","string_music.wav"],
    io:{in:"Instruction + verbatim commentary + reference photos + recorded narration + music", out:["Multi-shot dynamic video","Supplied narration reused as-is","Subtitles","Final audiovisual composition"]},
  },
  {
    key:"northspur", title:"The Long Way Round",
    genre:"Advertisement \u00b7 Product Story", cat:"Advertisement", pipeline:"advertisement",
    prompt:"I'll be giving you three things: a shot-by-shot script with the lines, a reference image of the main character plus our brand logo, and the narration audio I recorded along with a background music track. Put those together into a 30-second product-story ad — keep the character and the logo consistent, use my narration and my music, and lock the length to my audio. English, with English subtitles.",
    prompt_en:"The everything-supplied case: a shot-by-shot script, a character reference and a brand logo, plus the narration the user recorded and the music bed they want under it \u2014 five files, and the instruction to lock the length to the audio. The narration is used as recorded (no re-dubbing) and its subtitles come from transcribing that recording, not from the script. The runtime follows it: the supplied speech runs 34.1s, so the film was planned to cover it rather than to the brief's round '30 seconds'. The flask the script is about stays off-screen \u2014 only the character and the logo were given as references, and the system did not invent a hero shot for the product.",
    src:"videos/northspur.mp4", poster:"posters/northspur.jpg",
    inputs:["script.txt","character_ref.png","brand_logo.png","narration.wav","music_bed.wav"],
    io:{in:"Instruction + script + reference images + narration + music", out:["Multi-shot dynamic video","Supplied narration reused as-is","Subtitles","Final audiovisual composition"]},
  },
  {
    key:"vents", title:"Black Smokers",
    genre:"Explainer \u00b7 Science Infographic", cat:"Explainer", pipeline:"explainer",
    prompt:"I need a 90-second animated explainer on deep-sea hydrothermal vent ecosystems — black smokers — aimed at middle school through high school students. The accuracy is on me, so stick strictly to the script I've written out below and don't pad it or reword a single word of it: the temperature figures, the chemosynthesis mechanism and the tubeworm symbiosis are all things I've already checked. I'm also uploading two real research figures — a temperature-versus-depth profile at the vent, and a chemosynthetic food-web diagram — and when the narration reaches those parts I want both of them rendered accurately on screen as infographics; don't get the numbers or the structure wrong and don't prettify or fudge them. Whole thing in 2D explainer animation plus infographic style, cool palette, restrained and professional. English voice-over reading my script, with English subtitles. Other than the narration I don't want music stealing the show — just a bit of low underwater ambient foley.\n\nHere is the script, word for word:\n\nTwo and a half kilometres down, there is no sunlight at all. The water here sits at about two degrees Celsius. And yet, crowded around cracks in the seafloor, there are animals everywhere.\n\nThese cracks are hydrothermal vents. Seawater seeps into the crust, is heated by magma below, and comes roaring back out. At the orifice of a black smoker the fluid can reach about four hundred degrees Celsius — it does not boil, because the pressure at this depth is roughly two hundred and fifty times the pressure at the surface. The black smoke is not smoke: it is metal sulphide minerals crystallising the instant the hot fluid hits near-freezing seawater.\n\nNothing here photosynthesises. Instead, bacteria use chemosynthesis: they oxidise the hydrogen sulphide streaming out of the vent to get energy, and use that energy to fix carbon dioxide into sugars. Sunlight is replaced by chemistry.\n\nThe giant tubeworm Riftia pachyptila takes this one step further. An adult has no mouth and no gut. Inside its body is an organ packed with these bacteria, and the worm supplies them with hydrogen sulphide, oxygen and carbon dioxide carried in its blood. The bacteria feed the worm in return. Neither one survives alone — this is symbiosis.\n\nFrom those bacteria the food web climbs: tubeworms and mussels, then crabs and shrimp that graze on them, then fish at the top. An entire ecosystem, in permanent darkness, running on chemistry from the planet's own interior.",
    prompt_en:"A classroom explainer where the user supplies the script and forbids any rewording: the temperature figures, the chemosynthesis mechanism and the tubeworm symbiosis are all things they have already checked. Two real research figures are uploaded to be reproduced on screen. The narration is the supplied script VERBATIM \u2014 all 243 words, every figure intact, including the one an earlier cut lost (vent fluid does not boil because the pressure at depth is roughly 250x the surface). The script needed more speaking time than the requested 90 seconds, so the film ran to nine shots rather than compress it. Some of the denser diagram labels are misspelled by the image model \u2014 in-frame lettering at panel scale is still beyond it.",
    src:"videos/vents.mp4", poster:"posters/vents.jpg",
    inputs:["fig_temp_depth.png","fig_food_web.png"],
    io:{in:"Instruction + verbatim script + reference figures", out:["Multi-shot dynamic video","Scripted English voice-over","Subtitles","Final audiovisual composition"]},
  },
  {
