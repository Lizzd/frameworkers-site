...
const DEMOS = [
  ...
  },
  {
    ...
    prompt_en:"A footage-pack edit: the user drops a pile of loose travel and event clips of assorted lengths \u2014 throwaway takes included \u2014 and asks for the highlights cut into a reel, with the blurry, repetitive and boring parts thrown out. Here: 12 clips cut from CC-licensed contemporary footage (aerial beaches, Japanese coastline, Sikkim mountains, a mountain stream, a train window), deliberately salted with one out-of-focus take, two near-duplicates and a 22-second static stretch. The system described all 12 and selected six moments from six different sources; every salted throwaway was left out. No score \u2014 the brief asks for a music-synced cut and the music backend is currently unavailable.",
